...
main() {
    ...
    echo "Ensure your token has 'repo' and 'read:org' scopes (or at minimum 'Contents' for repo reads)."
    GITHUB_PERSONAL_ACCESS_TOKEN=$(ask_required "GitHub Personal Access Token")
